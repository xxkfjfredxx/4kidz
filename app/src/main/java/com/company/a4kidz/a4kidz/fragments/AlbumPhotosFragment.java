...
import com.company.a4kidz.a4kidz.adapters.AdapterListAlbum;
import com.company.a4kidz.a4kidz.adapters.AdapterListPhotos;
import com.company.a4kidz.a4kidz.adapters.AdapterPreviewAlbum;
        ...
        call.enqueue(new Callback<ResponseDataListDTO>() {
            ...
            public void onResponse(Call<ResponseDataListDTO> call, Response<ResponseDataListDTO> response) {
                if(response.body() != null) {
                    recyclerArtist.setAdapter(new AdapterPreviewAlbum(response.body().getMemories(), getActivity()));
                }
